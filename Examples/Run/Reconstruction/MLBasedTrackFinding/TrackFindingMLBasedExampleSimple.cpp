...
void test_py(int argc, char *argv[]){
  ROOT::EnableThreadSafety();
  const std::regex num_regex("^event([0-9]+)-");
...
int main(int argc, char** argv) {
  ...
  // trkFinderCfg.inputMLModuleName = "inference_fn";
  // trkFinderCfg.inputFuncName = "gnn_track_finding";
  // trkFinderCfg.outputProtoTracks = "protoTracks";
  // auto track_finder = std::make_shared<TrackFindingMLBasedAlgorithm>(trkFinderCfg, Acts::Logging::VERBOSE);
  // track_finder->execute();
